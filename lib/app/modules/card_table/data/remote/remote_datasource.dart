...
abstract class CardTableRemoteDatasource {
  Future<Either<CardTableFailure,  Map<String, dynamic>>> getNewDeck();
  ...
  Future<Either<CardTableFailure,  Map<String, dynamic>>> postDrawCard({required String count, required String deckId});
}
